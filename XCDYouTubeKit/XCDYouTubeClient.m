...
- (instancetype) initWithLanguageIdentifier:(NSString *)languageIdentifier
{
	...
	_queue.maxConcurrentOperationCount = 1; // paul_irish: Chrome re-confirmed that the 6 connections-per-host limit is the right magic number: https://code.google.com/p/chromium/issues/detail?id=285567#c14 [https://twitter.com/paul_irish/status/422808635698212864]
